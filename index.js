...
xhr.open(
    "GET",
    `https://cors-anywhere.herokuapp.com/http://newsapi.org/v2/top-headlines?country=${coun}&apiKey=${api}`,
    true
);

// https://cors-anywhere.herokuapp.com/

// http: //newsapi.org/v2/top-headlines?country=in&apiKey=a9b14d5f5d3448558fafd022dc27043f
...

{
    ...
    //             </button>
    //         </h2>
    //         <a href="${ur}" class="btn btn-primary my-2">Go To Site</a>
    //     </div>
    //     <div id="collapse${i}" class="collapse" aria-labelledby="heading${i}" data-parent="#accordionExample">
    //         <div class="card-body">
    //              ${desc}
