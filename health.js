...
Catergory : <span class="badge badge-secondary">Health</span>
</h2>`;
...
xhr.open(
    "GET",
    `https://cors-anywhere.herokuapp.com/http://newsapi.org/v2/top-headlines?country=${coun}&category=health&apiKey=${api}`,
    true
);
